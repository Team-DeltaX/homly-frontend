...
const BlacklistedUsersCardNew = (props) => {
    ...
    const fetchfromemployee = () => {
        axios.get(`http://localhost:8080/admin/auth/locationadmin/employee/${props.data.ServiceNo}`)
            .then((res) => {
    ...
    const fetchfromuser = () => {
        axios.get(`http://localhost:8080/admin/auth/locationadmin/user/${props.data.ServiceNo}`)
            .then((res) => {
                SetUser(res.data[0])
