                ...
                <Box>
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{
                            ...
                            <Box><Typography sx={{fontFamily:'roboto',flex:2}} h6>Service Number</Typography></Box>
                            <Box ><TextField
                        ...
                        <Box sx={{
                            ...
                            <Box><Typography sx={{fontFamily:'roboto',}} h6>Reservation Number</Typography></Box>
                        ...
                        <Box sx={{
                            ...
                            <Box><Typography sx={{fontFamily:'roboto',}} h6>Date</Typography></Box>
                        ...
                        <Box sx={{
                            ...
                            <Box ></Box> */}
                                    <Button variant='contained' sx={{fontFamily:'roboto',marginRight:'3%'}}  >Add To Blacklist</Button>
