...
const EditHall = ({ hallArray, setHallArray }) => {
  ...
  console.log("hallarray", hallArray);
  ...
  const handleHallCodeChange = (e) => {
    const hallCodeExists = hallArray.some(
      (hall) => hall.hallCode === e.target.value
    );
    if (hallCodeExists) {
      setHallExist(true);
    } else {
  ...
  const handleSaveHall = () => {
    if (
      hallValues.hallCode === "" ||
      hallValues.hallAc === "" ||
      hallValues.floorLevel === "" ||
      hallValues.hallRemark === "" ||
      hallValues.hallRental === ""
    ) {
  ...
  const handleHallDelete = (hallCode) => {
    //for room hallbreakdown component
  ...
  const handleRemoveRentalItem = (no) => {
    const newRentalArray = hallRentalArray.filter(
      (item, index) => index !== no
    );
          ...
          hallArray.map((item, index) => {
            return (
              <HallBreakDown
                ...
                hallNoOfAdults={item.hallNoOfAdults}
                hallNoOfChildren={item.hallNoOfChildren}
                hallRemarks={item.hallRemarks}
                hallRental={item.hallRental}
                handleHallDelete={handleHallDelete}
                handleHallEdit={handleHallEdit}
                index={index}
              />
            );
          })
      ...
      <React.Fragment>
        ...
        >
          ...
          <form>
            <DialogContent sx={{ maxHeight: "350px" }}>
              ...
              >
                ...
                <TextField
                  ...
                  label="Hall Name"
                  placeholder="Hall Name/Code"
                  fullWidth
                  size="small"
                  onChange={handleHallCodeChange}
                  helperText={hallExist ? "Already exist" : ""}
                  value={hallValues.hallCode}
                />
              </Box>
              <Box
                className="input_container"
              ...
              >
                ...
                <TextField
                  ...
                  fullWidth
                  size="small"
                  onChange={handleHallNoOfAdultsChange}
                  helperText={error.ctName ? "Invalid Input" : ""}
                  value={hallValues.hallNoOfAdults}
                />
              </Box>
              <Box
                className="input_container"
              ...
              >
                ...
                <TextField
                  ...
                  fullWidth
                  size="small"
                  onChange={handleHallNoOfChildrenChange}
                  helperText={error.ctName ? "Invalid Input" : ""}
                  value={hallValues.hallNoOfChildren}
                />
              </Box>
              ...
              >
                ...
                <TextField
                  ...
                  fullWidth
                  size="small"
                  onChange={handleHallRemarksChange}
                  helperText={error.ctName ? "Invalid Input" : ""}
                  value={hallValues.hallRemark}
                />
              </Box>
              <Box
                className="input_container"
              ...
              >
                ...
                <TextField
                  ...
                  fullWidth
                  size="small"
                  onChange={handleHallRentalChange}
                  helperText={error.ctName ? "Invalid Input" : ""}
                  value={hallValues.hallRental}
                />
              </Box>
            ...
            <DialogActions>
              <Button variant="contained" onClick={handleSaveHall}>
                Save
              </Button>
              <Button variant="outlined" onClick={handleCloseHall}>
                Close
              </Button>
            </DialogActions>
          </form>
