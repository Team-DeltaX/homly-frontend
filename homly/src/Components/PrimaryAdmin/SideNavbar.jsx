        ...
        <Box sx={{ width: '100%',paddingTop:"20px",fontFamily:theme.fontFamily}} >
          ...
          <Grid container sx={{height:"100vh"}} >
            ...
            <Box sx={{width:'100%',margin:'0 auto',marginBottom:'20px',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center'}}>
                ...
                <Grid container justifyContent={'flex-start'} alignItems={'center'}  xs={12} sx={{backgroundColor: selectedMenuItem === 'blacklistedusers' ? 'white' : 'primary.main'}} className='sidenav_item'>
                        <Box justifyContent={'center'}>
                            <DoNotDisturbAltIcon sx={{color:selectedMenuItem === 'blacklistedusers' ? 'black' : 'white'}}/>
                        </Box>
                        <Box alignItems={'center'}>
                            <Link to="/primaryadmin/blacklistedusers/manage" className='sidenav_link' >
                                <Typography variant='p' sx={{color:selectedMenuItem === 'blacklistedusers' ? 'black' : 'white',fontWeight:'bold'}}>BlacklistedUsers</Typography>
                            </Link>
                        </Box>
                </Grid>
                <Grid container xs={12} className="submenu_item">
                        <Grid container >
                            <Grid xs={12} sx={{display:'flex',justifyContent:'flex-start',padding:'3px',marginTop:'5px'}}>
                                <Link to="/primaryadmin/blacklistedusers/manage" className='sidenav_submenulink' >
                            ...
                            <Grid xs={12} sx={{display:'flex',justifyContent:'flex-start',padding:'3px',marginBottom:'5px'}}>
                                <Link to="/primaryadmin/blacklistedusers/history" className='sidenav_submenulink' >
                                    <HistoryOutlinedIcon sx={{color:'white',marginRight:'20px',fontSize:"1.2rem"}}/>
                                    <Typography variant='p' sx={{color:'white'}}>History</Typography>
                                </Link>
                            </Grid>
                            <Grid xs={12} sx={{display:'flex',justifyContent:'flex-start',padding:'3px',marginBottom:'5px'}}>
                                <Link to="/primaryadmin/blacklistedusers/complaints" className='sidenav_submenulink' >
                                    <SpeakerNotesIcon sx={{color:'white',marginRight:'20px',fontSize:"1.2rem"}}/>
                                    <Typography variant='p' sx={{color:'white'}}>Complaints</Typography>
                                </Link>
                            </Grid>
                ...
                <Grid container justifyContent={'flex-start'} alignItems={'center'}  xs={12} sx={{backgroundColor: selectedMenuItem === 'holidayhomes' ? 'white' : 'primary.main'}} className='sidenav_item' >
                        ...
                        <Box alignItems={'center'}>
                            <Link to="/primaryadmin/holidayhomes" className='sidenav_link' >
                                <Typography variant='p' sx={{color:selectedMenuItem === 'holidayhomes' ? 'black' : 'white'}}>Holiday Homes</Typography>
                            </Link>
                        </Box>
                </Grid>
            ...
            <Box sx={{width:'100%',display:'flex',flexDirection:'column', alignItems:'center',justifyContent:"flex-end"}}>
                ...
                <Box sx={{textAlign:'center'}}>
                    <Typography variant='h6' sx={{color:'white',marginBottom:'0'}}>Primary Admin</Typography>
