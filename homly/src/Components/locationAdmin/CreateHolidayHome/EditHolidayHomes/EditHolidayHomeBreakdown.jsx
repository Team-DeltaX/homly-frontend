  ...
  const handleAddRoomRentalSettings = () => {
    ...
    if (settingRoomRentalArray.length === 0) {
      ...
      for (let i = 0; i < settingRoomRentalArray.length; i++) {
        if (
          settingRoomRentalArray[i].roomType === settingsRoomRental.roomType &&
      ...
      >
        ...
        <Grid container spacing={2}>
          <Grid item md={12} sm={12} xs={12}>
            ...
            >
              <hr style={{ height: "0.5px", width: "30%", margin: 0 }}></hr>
              <Typography variant="p">Holiday Home Facilities</Typography>
              <hr style={{ height: "0.5px", width: "30%", margin: 0 }}></hr>
            </Box>
          </Grid>
          <Grid item md={6} sm={12} xs={12}>
            <FormGroup sx={{ display: "flex", width: "100%" }}>
              <Box sx={{ display: "flex", gap: "1em" }}>
                <FormControlLabel
                  control={<Checkbox />}
                  label="Gym"
                  checked={bdValue.gym === "on" ? true : false}
                  onChange={hangleGymChange}
                />
                <FormControlLabel
                  control={<Checkbox />}
                  label="Park"
                  checked={bdValue.park === "on" ? true : false}
                  onChange={handleParkChange}
                />
                <FormControlLabel
                  control={<Checkbox />}
                  label="Kitchen"
                  checked={bdValue.kitchen === "on" ? true : false}
              ...
              <Box sx={{ display: "flex", gap: "1em" }}>
                <FormControlLabel
                  control={<Checkbox />}
                  label="Bar"
                  checked={bdValue.bar === "on" ? true : false}
                  onChange={handleBarChange}
                />
                <FormControlLabel
                  control={<Checkbox />}
                  label="Wifi"
                  checked={bdValue.wifi === "on" ? true : false}
                  onChange={handleWifiChange}
                />
                <FormControlLabel
                  control={<Checkbox />}
                  label="Pool"
                  checked={bdValue.pool === "on" ? true : false}
