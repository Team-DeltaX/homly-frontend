...
const ViewUnit = ({ roomArray, setRoomArray, unitArray, setUnitArray }) => {
  ...
  const handleRemoveUnitRentalItem = (no) => {
    const newUnitRentalArray = unitRentalArray.filter(
      (item, index) => index !== no
    );
            ...
            <DialogContent sx={{ maxHeight: "350px" }}>
              ...
              >
                ...
                <TextField
                  ...
                  fullWidth
                  size="small"
                  onChange={handleUnitRentalChange}
                  helperText={error.ctName ? "Invalid Input" : ""}
                />
              </Box>
                ...
                >
                  ...
                  >
                    ...
                    <TextField
                      ...
                      size="small"
                      value={newUnitWeekDayValue}
                      onChange={handleUnitWeedays}
                      helperText={error.ctName ? "Invalid Input" : ""}
                      sx={{ width: "150px" }}
                    />
                    <TextField
                      ...
                      placeholder="Weekend"
                      size="small"
                      value={newUnitWeekendValue}
                      onChange={handleUnitWeekends}
                      helperText={error.ctName ? "Invalid Input" : ""}
                      sx={{ width: "150px" }}
                    />
                    <Button
                  ...
                  return (
                    <Box>
                      ...
                      >
                        ...
                        <CancelIcon
                          sx={{ cursor: "pointer" }}
                          onClick={() => handleRemoveUnitRentalItem(index)}
                        />
                      </Paper>
                    </Box>
                  );
