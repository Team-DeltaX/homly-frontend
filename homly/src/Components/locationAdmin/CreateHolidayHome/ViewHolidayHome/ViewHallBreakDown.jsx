...
const ViewHallBreakDown = ({ hallCode, hallAc, floorLevel, hallNoOfAdults, hallNoOfChildren, hallRental, handleHallEdit, index }) => {
    ...
    return (
        <Paper elevation={8} sx={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', padding: "10px", marginBottom: "10px" }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: '1em' }}>
                <Button size='small' variant='contained' sx={{ backgroundColor: 'primary.main' }} onClick={() => handleHallEdit(index)}>View Row</Button>
            </Box>
