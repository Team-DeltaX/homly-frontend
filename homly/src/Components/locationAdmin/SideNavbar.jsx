            ...
            <Box sx={{ width: '100%', paddingTop: "20px", position: 'relative' }}>
                ...
                <Grid container sx={{ height: "100vh" }} >
                    ...
                    <Box sx={{ width: '100%', margin: '0 auto', marginBottom: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <Grid container justifyContent={'flex-start'} alignItems={'center'} xs={12} sx={{ backgroundColor: selectedMenuItem === 'manage' ? 'white' : 'primary.main' }} className='sidenav_item'>
                            <Box justifyContent={'center'}>
                                <HomeOutlinedIcon sx={{ color: selectedMenuItem === 'manage' ? 'black' : 'white' }} />
                            </Box>
                            <Box alignItems={'center'}>
                                <Link to="/locationadmin/manage" className='sidenav_link' >
                                    <Typography variant='p' sx={{ color: selectedMenuItem === 'manage' ? 'black' : 'white', fontWeight: 'bold' }}>HolidayHomes Manage</Typography>
                                </Link>
                            </Box>
                        </Grid>
                        <Grid container justifyContent={'flex-start'} alignItems={'center'} xs={12} sx={{ backgroundColor: selectedMenuItem === 'details' ? 'white' : 'primary.main' }} className='sidenav_item'>
                            <Box justifyContent={'center'}>
                                <HomeOutlinedIcon sx={{ color: selectedMenuItem === 'details' ? 'black' : 'white' }} />
                            </Box>
                            <Box alignItems={'center'}>
                                <Link to="/locationadmin/details" className='sidenav_link' >
                                    <Typography variant='p' sx={{ color: selectedMenuItem === 'details' ? 'black' : 'white', fontWeight: 'bold' }}>HolidayHomes Details</Typography>
                                </Link>
                            </Box>
                        </Grid>
