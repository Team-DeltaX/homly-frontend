...
const PastReservationCard = (props) => {
  ...
  const fetchfromemployee = () => {
    axios
      .get(
        `http://localhost:8080/admin/auth/locationadmin/employee/${props.reservation.ServiceNO}`
      )
      .then((res) => {
      ...
      <Grid container className="columnData" sx={{ width: "100%" }}>
        ...
        >
          <img
            ...
            src={
              "https://images.unsplash.com/photo-1605352081508-2e09927ecfe3?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aG9saWRheSUyMGhvbWV8ZW58MHx8MHx8fDA%3D"
            }
            alt=""
          />
